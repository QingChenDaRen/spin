...
# Set up the model.
  model none
  model TBabs*constant*simplcutx*(ezdiskbb + laor)*constant & /*
...
# Set up parameters
  ...
  newpar 8 300 0.01 0.0001 0.0001 10000 10000
  newpar 9 6.5 -0.01
  newpar 10 3.0 -0.01
...
# Input sorted M,i,D from Python code
  set filename MiD_mid_to_high_test.dat
...
# Use all other values from previous fit
  ...
  newpar 13 ${inc} -0.01 0.0 0.0 90.0 90.0

  freeze 1 2 5 9 10 11 12 13
# Set systematics
# systematic 0.01
...
# Save the .xcm file
  save all ${obsname}_${M}_${inc}_${D}_m2h.xcm
...
puts $chan "$obsname \t$mychi \t$mydof \t${M} \t${inc} \t${D} \t$par1 \t$par2 \t$par3 \t$par4 \t$par5 \t$par6 \t$par7 \t$par8 \t$par9 \t$par10 \t$par11 \t$par12 \t$par13 \t$par14 \t$par15"
